...
Web前端技术由html、css和javascript三大部分构成，是一个庞大而复杂的技术体系，其复杂程度不低于任何一门后端语言。而我们在学习它的时候往往是先从某一个点切入，然后不断地接触和学习新的知识点，因此对于初学者很难理清楚整个体系的脉络结构。所以，这篇文章是结合网上资料和学习经验对前端核心知识进行总结与归纳。

> 作者：前端与移动开发 The front-end development [博客|CSDN](http://blog.csdn.net/wu_xianqiang) [知乎|专栏](https://zhuanlan.zhihu.com/webqianduan) [微信公众号](https://github.com/wuxianqiang/learning-course/blob/master/weixin.jpg)
